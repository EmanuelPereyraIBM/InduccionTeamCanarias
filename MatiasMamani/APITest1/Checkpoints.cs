    ...
    public partial class WorkFlowScript
    {
        ...
        private void set_StServiceCallActivity4_checkpoints(STActivityBase activity)
        {
            ...
            CpValObj ExpectedSchema = new CpValObj("<?xml version=\"1.0\" encoding=\"utf-16\"?><xs:schema xmlns=\"http://schemas.xmlsoap.o" +
                    ...
                    "antage.online.store.accountservice\" ref=\"q1:AccountLoginResponse\" /></xs:sequenc" +
                    "e><xs:anyAttribute namespace=\"##any\" processContents=\"lax\"><xs:annotation><xs:do" +
                    "cumentation>Prose in the spec does not specify that attributes are allowed on th" +
                    "e Body element</xs:documentation></xs:annotation></xs:anyAttribute></xs:complexT" +
                    "ype><xs:attribute name=\"mustUnderstand\"><xs:simpleType><xs:restriction base=\"xs:" +
                    "boolean\"><xs:pattern value=\"0|1\" /></xs:restriction></xs:simpleType></xs:attribu" +
                    "te><xs:attribute name=\"actor\" type=\"xs:anyURI\" /><xs:simpleType name=\"encodingSt" +
                    "yle\"><xs:annotation><xs:documentation>\'encodingStyle\' indicates any canonicaliza" +
                    ...
                    "escribed in SOAP specification</xs:documentation></xs:annotation><xs:list itemTy" +
                    "pe=\"xs:anyURI\" /></xs:simpleType><xs:attribute name=\"encodingStyle\" type=\"encodi" +
                    "ngStyle\" /><xs:attributeGroup name=\"encodingStyle\"><xs:attribute ref=\"encodingSt" +
                    "yle\" /></xs:attributeGroup><xs:element name=\"Fault\" type=\"Fault\" /><xs:complexTy" +
                    "pe name=\"Fault\" final=\"extension\"><xs:annotation><xs:documentation>Fault reporti" +
                    "ng structure</xs:documentation></xs:annotation><xs:sequence><xs:element name=\"fa" +
                    "ultcode\" type=\"xs:QName\" /><xs:element name=\"faultstring\" type=\"xs:string\" /><xs" +
                    ":element minOccurs=\"0\" name=\"faultactor\" type=\"xs:anyURI\" /><xs:element minOccur" +
                    "s=\"0\" name=\"detail\" type=\"detail\" /></xs:sequence></xs:complexType><xs:complexTy" +
                    "pe name=\"detail\"><xs:sequence><xs:any minOccurs=\"0\" maxOccurs=\"unbounded\" namesp" +
                    "ace=\"##any\" processContents=\"lax\" /></xs:sequence><xs:anyAttribute namespace=\"##" +
